...
export default function LoginPage() {
  ...
  const handleLogin = (e) => {
    ...
    if (email === "admin@gmail.com" && password === "hadil2002") {
        ...
        >
          ...
          <div className="flex justify-center items-center mb-6">
            <img
              ...
              alt="Logo ESSS"
              className="h-20 w-auto justify-center item-center"
            />
          </div>
          ...
          {error && <p className="text-red-600 text-center md:text-left mb-6">{error}</p>}
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-xl px-5 py-4 focus:ring-2 focus:ring-red-600 focus:outline-none placeholder-gray-600 text-black text-lg transition-all duration-300 hover:scale-105"
              />
            </div>
